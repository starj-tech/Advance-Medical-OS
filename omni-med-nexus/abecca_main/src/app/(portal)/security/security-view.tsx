...
export function SecurityView() {
  ...
  const copySecret = async () => {
    ...
    try {
      ...
      // Clipboard may be blocked; the secret is shown for manual entry anyway.
    }
  };
  ...
  return (
    <div className="flex max-w-2xl flex-col gap-6 animate-fade-in">
      <div>
        <h1 className="text-xl font-semibold tracking-tight">Keamanan Akun</h1>
        <p className="mt-1 text-sm text-muted-foreground">
          Tambahkan verifikasi dua langkah (2FA) berbasis aplikasi authenticator untuk
          melindungi akun Anda — wajib bagi banyak rumah sakit besar.
        </p>
      </div>
            ...
            <>
              ...
              <div className="rounded-lg border border-border bg-muted/40 p-3">
                ...
                <div className="mt-1 flex items-center gap-2">
                  ...
                  <Button size="sm" variant="ghost" onClick={copySecret} aria-label="Salin kunci">
