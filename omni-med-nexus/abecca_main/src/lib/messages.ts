...
export interface Messages {
  nav: {
    ...
    safety: string; riskRegister: string; infectionControl: string;
...
const id: Messages = {
  nav: {
    ...
    procurement: "Pengadaan", tariffs: "Tarif", safety: "Keselamatan",
    riskRegister: "Manajemen Risiko", infectionControl: "PPI / Infeksi",
...
const en: Messages = {
  nav: {
    ...
    procurement: "Procurement", tariffs: "Tariffs", safety: "Patient Safety",
    riskRegister: "Risk Management", infectionControl: "IPC / Infection",
