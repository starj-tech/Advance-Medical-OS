...
import { ReferralPanel } from "@/components/clinical/referral-panel";
                ...
                <li key={e.id}>
                  ...
                  {isOpen && (
                    <div className="space-y-3 bg-foreground/[0.015] px-5 py-4">
                      ...
                      <EPrescriptionPanel encounterId={e.id} active={e.status === "in_progress"} />
                      ...
                      <ReferralPanel encounterId={e.id} active={e.status === "in_progress"} />
