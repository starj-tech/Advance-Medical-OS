...
export interface Messages {
  nav: {
    ...
    antimicrobial: string; qualityIndicators: string; credentials: string; staffDirectory: string; privileging: string; audit: string;
...
const id: Messages = {
  nav: {
    ...
    antimicrobial: "Stewardship Antimikroba", qualityIndicators: "Indikator Mutu", credentials: "Kredensial Nakes", staffDirectory: "Direktori Staf", privileging: "Kewenangan Klinis",
...
const en: Messages = {
  nav: {
    ...
    antimicrobial: "Antimicrobial Stewardship", qualityIndicators: "Quality Indicators", credentials: "Staff Credentials", staffDirectory: "Staff Directory", privileging: "Clinical Privileging",
    audit: "Audit Trail", observability: "Observability",
