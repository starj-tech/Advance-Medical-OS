...
export interface Messages {
  nav: {
    ...
    specialCare: string; assessments: string; forms: string; devices: string; biomedical: string; helpdesk: string; contracts: string; formulary: string;
...
const id: Messages = {
  nav: {
    ...
    specialCare: "Unit Khusus", assessments: "Asesmen Risiko", forms: "Form Dinamis", devices: "Perangkat", biomedical: "Aset Biomedik", helpdesk: "Helpdesk TI", contracts: "Vendor & Kontrak",
...
const en: Messages = {
  nav: {
    ...
    specialCare: "Special Care", assessments: "Risk Scales", forms: "Dynamic Forms", devices: "Devices", biomedical: "Biomedical Assets", helpdesk: "IT Helpdesk", contracts: "Vendors & Contracts",
