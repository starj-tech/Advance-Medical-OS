...
const nav: { href: string; key: keyof Messages["nav"]; icon: typeof LayoutDashboard }[] = [
  ...
  { href: "/assessments", key: "assessments", icon: PersonStanding },
  ...
  { href: "/helpdesk", key: "helpdesk", icon: LifeBuoy },
  ...
  { href: "/recall", key: "recall", icon: PackageX },
  ...
  { href: "/roster", key: "roster", icon: CalendarRange },
